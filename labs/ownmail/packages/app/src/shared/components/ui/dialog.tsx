...
const PRESENTATION_CLASS: Record<DialogPresentation, string> = {
	...
	'bottom-sheet':
		'fixed inset-x-0 bottom-0 w-full max-h-[calc(100dvh-var(--safe-area-top))] rounded-t-2xl sm:top-1/2 sm:left-1/2 sm:max-w-lg sm:-translate-x-1/2 sm:-translate-y-1/2 sm:rounded-xl',
