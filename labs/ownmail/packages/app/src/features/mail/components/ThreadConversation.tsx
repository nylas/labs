...
function AttachmentLink({ attachment, messageId }: { attachment: Attachment; messageId: string }) {
	return (
		<a
			...
			className="inline-flex min-h-11 items-center gap-2 rounded-lg border border-border bg-card px-3 py-1.5 text-sm transition-colors hover:bg-accent focus-visible:outline-none focus-visible:ring-[3px] focus-visible:ring-ring dark:bg-muted/40 dark:hover:bg-muted"
